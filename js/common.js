$(document).ready(function() {
	...
	$(".type-grid__list").click(function(e) {
		$(".row_cards").addClass("row_list");
	});
	$(".type-grid__grid").click(function(e) {
		$(".row_cards").removeClass("row_list");
	});

	$(".type-grid a").click(function(e) {
		e.preventDefault();
...
$(".sorting-more").click(function(e) {
	...
	$('.item-portfolio__slider').each(function(){
		var $this = $(this),
		$blockArrows = $(this).parent().siblings().find(".item-portfolio__controls");
		$this.slick({
			dots: false,
			arrows: true,
			slidesToShow:2,
	...
	$('.item-portfolio__bigslider').each(function(){
		var $this = $(this),
		$blockArrows = $(this).parent().siblings().find(".item-portfolio__controls");
		$this.slick({
			dots: false,
